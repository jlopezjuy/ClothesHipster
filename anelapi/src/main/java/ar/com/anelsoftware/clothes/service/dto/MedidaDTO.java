...
import ar.com.anelsoftware.clothes.domain.enumeration.TipoFalda;
...
public class MedidaDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if ( ! Objects.equals(id, medidaDTO.id)) { return false; }
    ...
    public String toString() {
        return "MedidaDTO{" +
            ...
            ", sisaDelantero='" + sisaDelantero + "'" +
            ", sisaEspalda='" + sisaEspalda + "'" +
            ", contornoCintura='" + contornoCintura + "'" +
            ", anteCadera='" + anteCadera + "'" +
            ", contornoCadera='" + contornoCadera + "'" +
            ", posicionCadera='" + posicionCadera + "'" +
            ", largoFalda='" + largoFalda + "'" +
            ", tipoFalda='" + tipoFalda + "'" +
            ", fechaMedida='" + fechaMedida + "'" +
            ", anchoEspalda='" + anchoEspalda + "'" +
            ", anchoManga='" + anchoManga + "'" +
            ", tiroPantalon='" + tiroPantalon + "'" +
            ", anchoPinzaPantalon='" + anchoPinzaPantalon + "'" +
            ", anchoRodillaPantalon='" + anchoRodillaPantalon + "'" +
            ", botaPantalon='" + botaPantalon + "'" +
